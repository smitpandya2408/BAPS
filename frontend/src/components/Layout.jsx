...
import { LayoutDashboard, FilePlus, LogOut, UserCircle, Menu, X } from 'lucide-react';
...
const Layout = () => {
    ...
    const navItems = [
        ...
        { name: 'નવું ફોર્મ', path: '/new-form', icon: <FilePlus size={20} /> },
    ];
    ...
    return (
        <div className="flex h-screen bg-gray-50 overflow-hidden">
            ...
            `}>
                <div className="p-6 text-2xl font-bold border-b border-saffron-dark flex items-center justify-between">
                    <span className="tracking-tight">BAPS સંસ્કારધામ</span>
            ...
            <div className="flex-1 flex flex-col min-w-0">
                {/* Navbar */}
                <header className="bg-white shadow-md h-20 flex items-center justify-between px-4 md:px-10 no-print z-10 shrink-0">
                    ...
                    <div className="flex items-center gap-2 md:gap-4 shrink-0">
                        <div className="hidden sm:flex flex-col items-end mr-2">
                            ...
                            <span className="text-[10px] text-saffron-dark font-bold uppercase tracking-widest">Administrator</span>
                        </div>
                ...
                {/* Content Container */}
                <main className="flex-1 overflow-x-hidden overflow-y-auto p-4 md:p-8 bg-gray-50/50">
